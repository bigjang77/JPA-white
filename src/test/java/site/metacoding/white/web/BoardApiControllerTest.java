...
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;//클래스명 안적고 바로적을수있다

import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;//클래스명 안적고 바로적을수있다
...
public class BoardApiControllerTest {
    ...
    public void update_test() throws Exception {
        ...
        boardupdateReqDto.setContent("트랜잭션망치기");
    ...
    public void deleteById_test() throws Exception {
        ...
        // when
        ResultActions resultActions = mvc
                .perform(MockMvcRequestBuilders.delete("/s/board/" + id)
